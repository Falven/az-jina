...
locals {
  ...
  custom_domains = [
    for domain in var.custom_domains : {
      name = domain.name
      certificate_id = (
        domain.certificate_id != null && domain.certificate_id != "" ? domain.certificate_id : null
      )
      certificate_binding_type = (
        domain.certificate_binding_type != null && domain.certificate_binding_type != ""
        ? domain.certificate_binding_type
        : null
      )
    }
  ]
